...
namespace ProjetoPI
{
    public partial class frmEditUsu: Form
    {
        public frmEditUsu()
        {
            InitializeComponent();
        ...
        private void usuarioBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(statusComboBox.Text))
                    throw new Exception("O status do usuário deve ser preenchido.");
                ...
                this.usuarioTableAdapter.Update(this.dbServicoDataSet.Usuario);
                ...
                LogSistema.RegistrarAcao(frmLogin.SessaoUsuario.CodUsuLog.ToString(), "Edição de Usuário", detalhes);
        ...
        private void frmEditUsu_Load(object sender, EventArgs e)
        {
